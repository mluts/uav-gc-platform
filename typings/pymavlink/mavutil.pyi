...
class mavfile:
    ...
    def recv_match(self, condition: str | None = ..., type: str | list[str] | set[str] | None = ...,
                   blocking: bool = ..., timeout: float | None = ...) -> Any:
    ...
    def wait_heartbeat(self, blocking: bool = ..., timeout: float | None = ...) -> Any:
...
def mavlink_connection(device: str, baud=..., source_system=..., source_component=..., planner_format=..., write=..., append=..., robust_parsing=..., notimestamps=..., input=..., dialect=..., autoreconnect=..., zero_time_base=..., retries=..., use_native=..., force_connected=..., progress_callback=..., udp_timeout=..., **opts) -> mavfile:
